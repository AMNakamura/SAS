/* ***************************************************************************
	...
	Date:		Orig. 6/1/2012 - Updated for ARIES project 11/22/2017
...
* This will take a while. Test in DOS command prompt first.;
...
%getFileSizes(k:\ADAP\DataDev,all,GotFiles);
